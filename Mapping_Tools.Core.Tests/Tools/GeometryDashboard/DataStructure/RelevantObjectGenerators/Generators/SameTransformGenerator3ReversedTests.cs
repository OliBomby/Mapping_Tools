...
[TestClass]
public sealed class SameTransformGenerator3ReversedTests
{
    [TestMethod]
    public void GetRelevantObjects_WithQuarterTurn_ReflectsTurnDirectionForNextStep()
    {
        // Arrange
        SameTransformGenerator3Reversed generator = new();
