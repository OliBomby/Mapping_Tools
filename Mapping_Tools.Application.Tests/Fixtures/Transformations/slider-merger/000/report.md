...
With effectively unlimited leniency and linear gap connections, the 12 eligible objects before the spinner became one
2,218.35 px Bézier slider. The four eligible objects after the spinner became one 947.07 px Bézier slider. The spinner
split the two merge groups and remained unchanged. The legacy message counts the 16 source sliders/circles participating
in merges. The backup is byte-identical to the seed.
