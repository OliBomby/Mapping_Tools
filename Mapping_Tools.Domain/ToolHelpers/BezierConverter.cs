...
using Mapping_Tools.Domain.Beatmaps.SliderPaths;
using Mapping_Tools.Domain.MathUtil;

namespace Mapping_Tools.Domain.ToolHelpers;

internal struct CircleBezierPreset(double maxAngle, List<Vector2> points) {
    public readonly double MaxAngle = maxAngle;
    public readonly List<Vector2> Points = points;
}

/// <summary>
/// Converts a slider between different types of curves.
/// </summary>
public static class BezierConverter
{
    private static readonly List<CircleBezierPreset> circlePresets = [
        ...
        new(5.69720464620727, GetPoints("1.0:0.0|1.0:1.4137783|-1.4305235:2.0779421|-2.3410065:-0.94017583|0.05132711:-1.7309346|0.8331702:-0.5530167")),
        new(2 * Math.PI, GetPoints("1.0:0.0|1.0:1.2447058|-0.8526471:2.118367|-2.6211002:7.854936e-06|-0.8526448:-2.118357|1.0:-1.2447058|1.0:-2.4492937e-16")),
    ];
