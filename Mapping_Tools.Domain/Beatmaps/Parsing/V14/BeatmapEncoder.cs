...
public class BeatmapEncoder(
    ...
    private IEnumerable<string> EncodeEnumerable(Beatmap beatmap) {
        ...
        if (beatmap.Editor.Bookmarks.Count > 0) {
            ...
            builder.AppendJoin(',', beatmap.Editor.Bookmarks.Select(b => b.ToRoundInvariant()));
        ...
        yield return storyboardEncoder.Encode(beatmap.Storyboard);
    ...
    public string Encode(Beatmap obj) {
