...
public class AnimationEncoder : IEncoder<Animation>
{
    ...
    {
        return $"{obj.EventType},{obj.Layer},{obj.Origin},\"{obj.FilePath}\",{obj.Pos.X.ToRoundInvariant()},{obj.Pos.Y.ToRoundInvariant()},{obj.FrameCount.ToInvariant()},{obj.FrameDelay.ToInvariant()},{obj.LoopType}";
    }
}