...
using Mapping_Tools.Domain.Beatmaps.Parsing.Decoding.HitObjects;
...
namespace Mapping_Tools.Domain.Beatmaps.Parsing.Decoding;

public class BeatmapDecoder : IDecoder<Beatmap> {
    ...
    public BeatmapDecoder(IDecoder<Storyboard> storyboardDecoder, IDecoder<HitObject> hitObjectDecoder, IDecoder<TimingPoint> timingPointDecoder) {
