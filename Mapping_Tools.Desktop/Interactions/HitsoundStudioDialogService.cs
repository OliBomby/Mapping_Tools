...
public sealed partial class HitsoundStudioImportDialogViewModel : ObservableObject
{
    ...
    [ObservableProperty] public partial ImportType ImportType { get; set; } = ImportType.None;
    /// <summary>Gets or sets the sample family.</summary>
    [ObservableProperty] public partial SampleSet SampleSet { get; set; } = SampleSet.Normal;
    /// <summary>Gets or sets the hitsound.</summary>
    [ObservableProperty] public partial Hitsound Hitsound { get; set; } = Hitsound.Normal;
    /// <summary>Gets or sets the audio/SoundFont path for a simple layer.</summary>
    [ObservableProperty] public partial string SamplePath { get; set; } = string.Empty;
    /// <summary>Gets or sets source paths separated by newlines.</summary>
    [ObservableProperty] public partial string SourcePaths { get; set; } = string.Empty;
    /// <summary>Gets or sets the stack X filter text.</summary>
    [ObservableProperty] public partial string XText { get; set; } = "-1";
    /// <summary>Gets or sets the stack Y filter text.</summary>
    [ObservableProperty] public partial string YText { get; set; } = "-1";
    /// <summary>Gets or sets the MIDI offset text.</summary>
    [ObservableProperty] public partial string OffsetText { get; set; } = "0";
    /// <summary>Gets or sets whether source volumes create separate layers.</summary>
    [ObservableProperty] public partial bool DiscriminateVolumes { get; set; }
    /// <summary>Gets or sets whether identical sample data is canonicalized.</summary>
    [ObservableProperty] public partial bool DetectDuplicateSamples { get; set; }
    ...
    [ObservableProperty] public partial bool IncludeStoryboard { get; set; }
    /// <summary>Gets or sets whether MIDI instruments are part of layer identity.</summary>
    [ObservableProperty] public partial bool DiscriminateInstruments { get; set; } = true;
    /// <summary>Gets or sets whether MIDI keys are part of layer identity.</summary>
    [ObservableProperty] public partial bool DiscriminateKeys { get; set; } = true;
    /// <summary>Gets or sets whether MIDI lengths are part of layer identity.</summary>
    [ObservableProperty] public partial bool DiscriminateLengths { get; set; }
    /// <summary>Gets or sets whether MIDI velocities are part of layer identity.</summary>
    [ObservableProperty] public partial bool DiscriminateVelocities { get; set; }
    /// <summary>Gets or sets the MIDI length roughness.</summary>
    [ObservableProperty] public partial string LengthRoughnessText { get; set; } = "2";
    /// <summary>Gets or sets the MIDI velocity roughness.</summary>
    [ObservableProperty] public partial string VelocityRoughnessText { get; set; } = "10";
    /// <summary>Gets the validation message.</summary>
    [ObservableProperty] public partial string Error { get; private set; } = string.Empty;
    ...
    {
        Error = string.Empty;
        if (!TryParse(XText, -1, out double x) || !TryParse(YText, -1, out double y) ||
...
public sealed partial class HitsoundStudioExportDialogViewModel : ObservableObject
{
    ...
    [ObservableProperty] public partial string ExportFolder { get; set; }
    /// <summary>Gets or sets the map version name.</summary>
    [ObservableProperty] public partial string HitsoundDiffName { get; set; }
    /// <summary>Gets or sets whether the map is exported.</summary>
    [ObservableProperty] public partial bool ExportMap { get; set; }
    /// <summary>Gets or sets whether samples are exported.</summary>
    [ObservableProperty] public partial bool ExportSamples { get; set; }
    /// <summary>Gets or sets whether the detailed completion summary is shown.</summary>
    [ObservableProperty] public partial bool ShowResults { get; set; }
    /// <summary>Gets or sets whether the output is cleared.</summary>
    [ObservableProperty] public partial bool DeleteAllInExportFirst { get; set; }
    /// <summary>Gets or sets whether the prior schema is used.</summary>
    [ObservableProperty] public partial bool UsePreviousSampleSchema { get; set; }
    /// <summary>Gets or sets whether the prior schema may grow.</summary>
    [ObservableProperty] public partial bool AllowGrowthPreviousSampleSchema { get; set; }
    /// <summary>Gets or sets whether coinciding modes retain regular hitsounds.</summary>
    [ObservableProperty] public partial bool AddCoincidingRegularHitsounds { get; set; }
    /// <summary>Gets or sets whether MIDI includes greenline volume.</summary>
    [ObservableProperty] public partial bool AddGreenLineVolumeToMidi { get; set; }
    /// <summary>Gets or sets export mode.</summary>
    [ObservableProperty] public partial HitsoundStudioExportMode HitsoundExportModeSetting { get; set; }
    ...
    [ObservableProperty] public partial GameMode HitsoundExportGameMode { get; set; }
    /// <summary>Gets or sets time grouping leniency.</summary>
    [ObservableProperty] public partial double ZipLayersLeniency { get; set; }
    /// <summary>Gets or sets the first custom index.</summary>
    [ObservableProperty] public partial int FirstCustomIndex { get; set; }
    /// <summary>Gets or sets single-source format.</summary>
    [ObservableProperty] public partial HitsoundStudioSampleExportFormat SingleSampleExportFormat { get; set; }
    /// <summary>Gets or sets mixed-source format.</summary>
    [ObservableProperty] public partial HitsoundStudioSampleExportFormat MixedSampleExportFormat { get; set; }
