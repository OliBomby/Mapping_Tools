...
public class RightScrimNavigationDrawer : ContentControl
{
    /// <summary>
    /// <b>Internal use!</b>
    ...
    public static readonly StyledProperty<Thickness> ContentMarginProperty =
        AvaloniaProperty.Register<RightScrimNavigationDrawer, Thickness>(nameof(ContentMargin));

    public static readonly StyledProperty<object> LeftDrawerContentProperty =
        AvaloniaProperty.Register<RightScrimNavigationDrawer, object>(nameof(LeftDrawerContent));

    public static readonly StyledProperty<IDataTemplate> LeftDrawerContentTemplateProperty =
        AvaloniaProperty.Register<RightScrimNavigationDrawer, IDataTemplate>(nameof(LeftDrawerContentTemplate));

    public static readonly StyledProperty<bool> LeftDrawerOpenedProperty =
        AvaloniaProperty.Register<RightScrimNavigationDrawer, bool>(nameof(LeftDrawerOpened));

    public static readonly StyledProperty<double> LeftDrawerWidthProperty =
        AvaloniaProperty.Register<RightScrimNavigationDrawer, double>(nameof(LeftDrawerWidth));

    public static readonly StyledProperty<double?> LeftDrawerExpandThresholdWidthProperty =
        AvaloniaProperty.Register<RightScrimNavigationDrawer, double?>(nameof(LeftDrawerExpandThresholdWidth));


    public static readonly StyledProperty<object> RightDrawerContentProperty =
        AvaloniaProperty.Register<RightScrimNavigationDrawer, object>(nameof(RightDrawerContent));

    public static readonly StyledProperty<IDataTemplate> RightDrawerContentTemplateProperty =
        AvaloniaProperty.Register<RightScrimNavigationDrawer, IDataTemplate>(nameof(RightDrawerContentTemplate));

    public static readonly StyledProperty<bool> RightDrawerOpenedProperty =
        AvaloniaProperty.Register<RightScrimNavigationDrawer, bool>(nameof(RightDrawerOpened));

    public static readonly StyledProperty<double> RightDrawerWidthProperty =
        AvaloniaProperty.Register<RightScrimNavigationDrawer, double>(nameof(RightDrawerWidth));

    public static readonly StyledProperty<double?> RightDrawerExpandThresholdWidthProperty =
        AvaloniaProperty.Register<RightScrimNavigationDrawer, double?>(nameof(RightDrawerExpandThresholdWidth));
    ...
    /// <summary>
    /// <p>Get or sets the width threshold of the RightScrimNavigationDrawer for expand left drawer automatically. Most used on desktop application.</p>
    ...
    /// <summary>
    /// <p>Get or sets the width threshold of the RightScrimNavigationDrawer for expand right drawer automatically. Most used on desktop application.</p>
    /// <p>For more information, please visit <a href="https://material.io/components/navigation-drawer#standard-drawer">material.io - Standard navigation drawer, Permanently visible</a> page.</p>
    ...
    static RightScrimNavigationDrawer()
    {
        BoundsProperty.Changed.AddClassHandler<RightScrimNavigationDrawer>(OnDrawerResized);

        LeftDrawerWidthProperty.Changed.AddClassHandler<RightScrimNavigationDrawer>(OnDrawerWidthChanged);
        RightDrawerWidthProperty.Changed.AddClassHandler<RightScrimNavigationDrawer>(OnDrawerWidthChanged);

        LeftDrawerOpenedProperty.Changed.AddClassHandler<RightScrimNavigationDrawer>(OnDrawerOpenedChanged);
        RightDrawerOpenedProperty.Changed.AddClassHandler<RightScrimNavigationDrawer>(OnDrawerOpenedChanged);

        LeftDrawerExpandThresholdWidthProperty.Changed.AddClassHandler<RightScrimNavigationDrawer>(
            OnDrawerExpandThresholdWidthChanged);
        RightDrawerExpandThresholdWidthProperty.Changed.AddClassHandler<RightScrimNavigationDrawer>(
            OnDrawerExpandThresholdWidthChanged);
    }

    private static void OnDrawerResized(RightScrimNavigationDrawer drawer, AvaloniaPropertyChangedEventArgs args)
    {
        drawer.UpdateDesktopExpand(drawer.Bounds.Width);
        drawer.UpdateContentMargin();
    }

    private static void OnDrawerWidthChanged(RightScrimNavigationDrawer drawer, AvaloniaPropertyChangedEventArgs args)
    {
    ...
    private static void OnDrawerExpandThresholdWidthChanged(
        RightScrimNavigationDrawer drawer, AvaloniaPropertyChangedEventArgs args)
    {
        drawer.UpdateDesktopExpand(drawer.Bounds.Width);
    }

    private static void OnDrawerOpenedChanged(RightScrimNavigationDrawer drawer,
