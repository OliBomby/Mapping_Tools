...
public sealed class PatternGalleryArchiveService : IPatternGalleryArchiveService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        ZipArchiveEntry projectEntry = archive.CreateEntry($"{collectionFolderName}/{projectFileName}");
        ...
        foreach (PatternGalleryArchiveFile patternFile in patternFiles)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (collectionFolder is null || projectFileName is null || projectJson is null)
        {
            throw new InvalidDataException("The archive must contain one project JSON file.");
        }
