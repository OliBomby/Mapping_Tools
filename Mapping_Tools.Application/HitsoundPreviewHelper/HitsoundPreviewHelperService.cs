...
public sealed class HitsoundPreviewHelperService : IHitsoundPreviewHelperService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new ArgumentException("There are no zones!", nameof(options));
        }

        if (options.ImportModeSetting == HitsoundPreviewHelperImportMode.Time &&
