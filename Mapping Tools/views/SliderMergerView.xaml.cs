...
namespace Mapping_Tools.Views {
    ...
    public partial class SliderMergerView :UserControl {
        ...
        private void Start_Click(object sender, RoutedEventArgs e) {
            ...
            double.TryParse(LeniencyBox.Text, NumberStyles.Any, CultureInfo.InvariantCulture, out double leniency);
            backgroundWorker.RunWorkerAsync(new Arguments(fileToCopy, leniency, (bool) ReqBookmBox.IsChecked));
