...
namespace Mapping_Tools_Core.Tools.HitsoundStudio.DataTypes {
    ...
    /// </summary>
    public interface ISampleSchema : IDictionary<string, ISet<ISampleGeneratingArgs>> {
        /// <summary>
        ...
        bool AddHitsound(ISet<ISampleGeneratingArgs> samples, string hitsoundName, SampleSet sampleSet,
            out int newIndex, out SampleSet newSampleSet, int startIndex = 1);
        
        string FindFilename(ISet<ISampleGeneratingArgs> samples);

        string FindFilename(ISet<ISampleGeneratingArgs> samples, string regexPattern);
        ...
        /// </summary>
        /// <returns></returns>
        IDictionary<ISampleGeneratingArgs, string> GetSampleNames();
