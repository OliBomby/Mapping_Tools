...
namespace Mapping_Tools_Core.Audio.SampleGeneration.Decorators {
    ...
    /// </summary>
    public class FadingSampleSoundDecorator : AudioSampleDecoratorAbstract {
        ...
        public FadingSampleSoundDecorator(IAudioSampleGenerator baseGenerator, double fadeStart, double fadeLength) : base(baseGenerator) {
            FadeStart = fadeStart;
            FadeLength = fadeLength;
        }

        public override bool Equals(ISampleGenerator other) {
            if (other is FadingSampleSoundDecorator fadingSampleSoundDecorator)
        ...
        public override object Clone() {
            return new FadingSampleSoundDecorator((IAudioSampleGenerator)BaseAudioGenerator.Clone(), FadeStart, FadeLength);
        }
