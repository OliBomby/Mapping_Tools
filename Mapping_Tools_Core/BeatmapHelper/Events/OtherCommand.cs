namespace Mapping_Tools_Core.BeatmapHelper.Events {
    ...
    public class OtherCommand : Command, IHasEndTime {
        ...
        public override string GetLine() {
            ...
            builder.Append(',');
            builder.Append((string) ((int) Easing).ToInvariant());
            builder.Append(',');
            builder.Append((string) StartTime.ToInvariant());
            builder.Append(',');
            builder.Append((string) EndTime.ToInvariant());

            foreach (var param in Params) {
                builder.Append(',');
                builder.Append((string) param.ToInvariant());
            }
