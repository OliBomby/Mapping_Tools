...
namespace Mapping_Tools_Core.BeatmapHelper {
    ...
    public class HitObjectOld : IComparable<HitObjectOld> {
        ...
        public HitObjectOld(string line) {
            // Example lines:
        ...
        public HitObjectOld(Vector2 pos, double time, HitObjectType type, bool newCombo, int comboSkip,
        ...
        public HitObjectOld(Vector2 pos, double time, int type, int hitsounds, SampleSet sampleSet, SampleSet additionSet,
            int index, double volume, string filename) {
            Pos = pos;
            // Let the end position be the same as the start position before changed later for sliders
            EndPos = Pos;
        ...
        public HitObjectOld(double time, int hitsounds, SampleSet sampleSet, SampleSet additions) {
        ...
        public int CompareTo(HitObjectOld other) {
