...
|---|---|---|
| `Mapping_Tools.Core.Tests` | Framework-neutral domain tests and versioned fixture contracts | Fixture catalog completeness, stable IDs, hashes, and destructive-feature baseline coverage |
