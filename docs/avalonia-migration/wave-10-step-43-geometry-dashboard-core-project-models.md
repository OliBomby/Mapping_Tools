...
- `Mapping_Tools/Views/SnappingTools/SnappingToolsView.xaml` and code-behind
- `Mapping_Tools/Views/SnappingTools/SnappingToolsProjectWindow.xaml` and code-behind
- `Mapping_Tools/Views/SnappingTools/SnappingToolsPreferencesWindow.xaml` and code-behind
- `Mapping_Tools/Views/SnappingTools/GeneratorSettingsWindow.xaml` and code-behind
