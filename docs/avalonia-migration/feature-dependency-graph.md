...
Implementation status: steps 8 through 11 are complete. Their contracts, adapters,
...
and [wave-2-step-11-beatmap-workspace.md](wave-2-step-11-beatmap-workspace.md).
