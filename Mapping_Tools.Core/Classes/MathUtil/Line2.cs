...
public struct Line2 : IEquatable<Line2>
{
    ...
    {
        return Math.Abs(left.DirectionVector.Y * right.X
                        - left.DirectionVector.X * right.Y
    ...
    {
        Intersection(left, right, out var result);
        return result;
    }
    ...
    public static bool operator ==(Line2 left, Line2 right) => left.Equals(right);
    ...
    {
        return PositionVector == other.PositionVector && DirectionVector == other.DirectionVector;
    }
}
