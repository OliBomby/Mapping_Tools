...
public class SamplePackage
{
    ...
    {
        foreach (var sample in Samples) sample.OutsideVolume = outsideVolume;
    }
    ...
    public CustomIndex GetCustomIndex(SampleGeneratingArgsComparer comparer = null)
    {
        ...
        var sampleSet = GetSampleSet();
        var additions = GetAdditions();

        var normals = new HashSet<SampleGeneratingArgs>(Samples.Where(o => o.Hitsound == Hitsound.Normal).Select(o => o.SampleArgs), comparer);
        var whistles = new HashSet<SampleGeneratingArgs>(Samples.Where(o => o.Hitsound == Hitsound.Whistle).Select(o => o.SampleArgs), comparer);
        var finishes = new HashSet<SampleGeneratingArgs>(Samples.Where(o => o.Hitsound == Hitsound.Finish).Select(o => o.SampleArgs), comparer);
        var claps = new HashSet<SampleGeneratingArgs>(Samples.Where(o => o.Hitsound == Hitsound.Clap).Select(o => o.SampleArgs), comparer);

        var ci = new CustomIndex(comparer);
