...
public class Video : Event, IHasStartTime
{
    ...
    public override string GetLine()
    {
        ...
        if (Pos == Vector2.Zero) return $"{EventType},{(SaveWithFloatPrecision ? StartTime.ToInvariant() : StartTime.ToRoundInvariant())},\"{Filename}\"";
    ...
    public override void SetLine(string line)
    {
        ...
        if (values[0] != "1" && values[0] != "Video") throw new BeatmapParsingException("This line is not a video.", line);
