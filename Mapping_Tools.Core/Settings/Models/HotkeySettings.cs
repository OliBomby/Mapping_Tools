...
/// <summary>
///     Stores UI <c>Key</c> and <c>KeyModifiers</c> values without making
...
///     project documents.
/// </summary>
/// <param name="Key">The key-enum value; zero disables the binding.</param>
/// <param name="Modifiers">The Alt, Control, Shift, and Meta flag bits.</param>
