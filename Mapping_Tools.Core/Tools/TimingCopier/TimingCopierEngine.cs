...
public static class TimingCopierEngine
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        List<Marker> markers = [];
        if (options.ResnapMode == TimingCopierResnapMode.PreserveBeatSpacing)
        ...
        if (options.ResnapMode == TimingCopierResnapMode.PreserveBeatSpacing && redlines.Count > 0)
        {
        ...
        else if (options.ResnapMode == TimingCopierResnapMode.Resnap && redlines.Count > 0)
        {
            // Resnap hitobjects
        ...
        if ((options.ResnapMode == TimingCopierResnapMode.Resnap || options.ResnapMode == TimingCopierResnapMode.PreserveBeatSpacing) && redlines.Count > 0)
        {
