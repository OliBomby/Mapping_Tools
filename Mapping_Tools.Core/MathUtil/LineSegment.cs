...
/// <summary>
///     Represents a line with infinite length using three double-precision floating-point numbers in the equation AX
///     + BY = C.
/// </summary>
/// <remarks>
...
public struct LineSegment : IEquatable<LineSegment>
{
    ...
    {
        Intersection(ref left, ref right, out var result);
        return result;
    }
    ...
    public static void Distance(ref LineSegment l, ref Vector2 p, out double result)
    {
        ...
        if (l2 == 0.0)
        {
            result = Vector2.Distance(l.P1, p);
            return;
        } // v == w case
        ...
        var projection = l.P1 + t * (l.P2 - l.P1); // Projection falls on the segment
